...
render --bbox $BBOX --zoom=18 --scale=2 --style=styles/tents.xml --file=layer-3-tents
render --bbox $BBOX --zoom=18 --scale=2 --style=styles/noc.xml --file=layer-4-noc
render --bbox $BBOX --zoom=18 --scale=2 --style=styles/gpscoords.xml --file=layer-5-gpscoords
